# Edgewalker Growth Cohort 2 — Prospective Analysis Plan
...
- Market data: IEX.
- Production strategy: Full Roster Edgewalker with the confirmed Opening Impulse lane, automatic +1% Bank Day, and the production sizing selected at launch.
- Opening Impulse doctrine: six completed bars, a 20-minute entry window, confirmed SOXL downside path and velocity, matching SOXS strength, waterfall-chase rejection, and stronger inverse confirmation in minutes 15–20.
...
Cohort 1 was superseded after one partial observation and zero completed sessions when the pre-warmup Opening Impulse production rule was introduced. Its database records remain intact; no Cohort 1 observation is promoted into Cohort 2.
...
All daily account returns use the broker-reported day P/L percentage captured by Edgewalker. Capital level is normalized in the primary return statistics while actual dollars, buying power, requested notional, and effective notional remain in the decision ledger for capacity and slippage analysis.
